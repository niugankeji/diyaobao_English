...
public class OtherDataListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OtherDataListAdapter(Context context) {
...
//        return holder;
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int i) {
        if (holder instanceof ViewHolder) {
            ...
            recyclerViewHolder.month.setText(s[1]+"月");
